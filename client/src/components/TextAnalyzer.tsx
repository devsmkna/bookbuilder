...
export function TextAnalyzer({ text, isVisible, onToggle, editorRef }: TextAnalyzerProps) {
  ...
  const [dialogueAnalysis, setDialogueAnalysis] =
              ...
              {textAnalysis ? (
                ...
                >
                  <div className="flex items-center gap-2 mt-4 mb-2">
                    ...
                    <Badge
                      variant={
                        textAnalysis.score > 70
                          ? "default"
                          : textAnalysis.score > 50
                            ? "outline"
                            : "secondary"
                      }
                    >
                    ...
                    <Card>
                      ...
                      <CardContent className="py-2">
                        <p className="text-sm mb-2">
                          Fai clic su qualsiasi parola nel testo per trovare
                          sinonimi:
                        </p>
                        {selectedWord ? (
                          <div className="mt-2">
                            <p className="text-sm mb-1 font-medium">
                              Sinonimi per "{selectedWord}":
                            </p>
                            {synonyms.length > 0 ? (
                          ...
                          <p className="text-sm text-muted-foreground">
                            Seleziona una parola dal testo.
                          </p>
                        )}
                      </CardContent>
                    </Card>
              ...
              {styleAnalysis ? (
                ...
                >
                  <div className="flex items-center gap-2 mt-4 mb-2">
                    ...
                    <Badge
                      variant={
                        styleAnalysis.score > 70
                          ? "default"
                          : styleAnalysis.score > 50
                            ? "outline"
                            : "secondary"
                      }
                    >
                        ...
                        <div className="space-y-2">
                          <div>
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="font-medium">
                                {styleAnalysis.wordVariety}%
                              </span>
                            </div>
                            <Progress
                              value={styleAnalysis.wordVariety}
                              className="h-1 mt-1"
                            />
                          </div>
                          ...
                          <div>
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="font-medium">
                                {styleAnalysis.readability}/100
                              </span>
                            </div>
                            <Progress
                              value={styleAnalysis.readability}
                              className="h-1 mt-1"
                            />
                          </div>
                          ...
                          <div className="text-sm mt-2">
                            <p>
                              ...
                              {styleAnalysis.sentenceLength.average} parole
                            </p>
                            <p>
                              <span className="font-medium">
                                Varietà lunghezza frasi:
                              </span>{" "}
                              {styleAnalysis.sentenceLength.variety}
                            </p>
                            <p className="text-xs text-muted-foreground mt-1">
                              (Un valore più alto indica maggiore varietà nel
                              ritmo)
                            </p>
                          </div>
                        </div>
                    ...
                    <Card>
                      ...
                      <CardContent className="py-2">
                        {styleAnalysis.suggestions.length > 0 ? (
                          ...
                          <p className="text-sm text-muted-foreground">
                            Lo stile del testo è ben bilanciato.
                          </p>
                        )}
                      </CardContent>
                    </Card>
                      ...
                      <CardContent className="py-2">
                        <ul className="space-y-1 text-sm">
                          <li>
                            ...
                            Maggiore è il valore, più ricco è il linguaggio
                            usato.
                          </li>
                          <li>
                            <span className="font-medium">Leggibilità:</span> Un
                            valore tra 40-60 è ideale per narrativa. Valori più
                            alti indicano testo più semplice.
                          </li>
                          <li>
                            <span className="font-medium">
                              Varietà lunghezza frasi:
                            </span>{" "}
                            Valori sopra 4 indicano un buon ritmo prosodico.
                          </li>
                        </ul>
                      </CardContent>
                    </Card>
              ...
              {dialogueAnalysis ? (
                ...
                >
                  <div className="flex items-center gap-2 mt-4 mb-2">
                    ...
                    <Badge
                      variant={
                        dialogueAnalysis.score > 70
                          ? "default"
                          : dialogueAnalysis.score > 50
                            ? "outline"
                            : "secondary"
                      }
                    >
                    ...
                    <Card>
                      ...
                      <CardContent className="py-2">
                        {dialogueAnalysis.suggestions.length > 0 ? (
                          <ul className="space-y-1 text-sm">
                            {dialogueAnalysis.suggestions.map(
                              (suggestion: string, i: number) => (
                                <li key={i} className="flex items-start">
                                  <span className="text-yellow-500 mr-1">
                                    •
                    ...
                    <Card>
                      <CardHeader className="py-2">
                        ...
                        <CardDescription className="text-xs">
                          Seleziona un dialogo per ricevere suggerimenti su come
                          migliorarlo
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="py-2">
                        {extractDialogues().length > 0 ? (
                          ...
                          <p className="text-sm text-muted-foreground">
                            Nessun dialogo trovato nel testo.
                          </p>
                        )}
                      ...
                      <CardContent className="py-2">
                        <ul className="space-y-1 text-sm">
                          <li className="flex items-start">
                            <span className="text-primary mr-1">•</span> Mostra
                            anziché dire (aggiungi azioni e reazioni fisiche)
                          </li>
                          <li className="flex items-start">
                            <span className="text-primary mr-1">•</span> Crea
                            "voci" uniche per ogni personaggio
                          </li>
                          <li className="flex items-start">
                            <span className="text-primary mr-1">•</span> Usa il
                            sottotesto (ciò che non viene detto)
                          </li>
                          <li className="flex items-start">
                            <span className="text-primary mr-1">•</span> Varia i
                            tag di dialogo (alternativa a "disse")
                          </li>
                        </ul>
                      </CardContent>
                    </Card>
